...
import { Bold, Italic, Link2, MessageSquare, Strikethrough, Underline } from 'lucide-react'
    ...
    >
      ...
      <button
        ...
        onClick={() => {
          ...
          const text = window.prompt('Komentár', '')
          if (text?.trim()) editor.chain().focus().setComment({ text: text.trim() }).run()
        }}
      >
