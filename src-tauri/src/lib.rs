...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::documents::library_find_replace,
            ...
            commands::nlp::nlp_extract_flashcards,
            commands::nlp::nlp_check_terminology,
            commands::nlp::nlp_extract_takeaways,
            ...
            commands::native_pipeline::export_document_by_id,
            commands::native_pipeline::compile_documents,
