...
impl ScribeStore {
    ...
    pub fn list_unresolved_wiki_links(&self, limit: i64) -> Result<Vec<UnresolvedWikiLink>, String> {
        list_unresolved_wiki_links(&self.db, limit)
    }
    ...
    pub fn list_stub_documents(
        ...
        list_stub_documents(&self.db, max_words, limit)
    }
    ...
    pub fn wiki_health(
        ...
        wiki_health(&self.db, unresolved_limit, stub_max_words, stub_limit)
    }
...
/// Orphans + unresolved wiki links + stub notes in one pass for the library panel.
pub fn wiki_health(
    conn: &Connection,
    unresolved_limit: i64,
    stub_max_words: i64,
