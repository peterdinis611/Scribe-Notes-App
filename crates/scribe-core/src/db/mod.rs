...
pub use embeddings::{
    ...
    get_embed_backend, is_nlp_enabled, rank_document_chunks, remove_embedding, save_artifact,
    semantic_search, semantic_search_filtered, set_embed_backend, set_nlp_enabled,
